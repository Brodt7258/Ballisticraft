...
@Mod(modid = BallisticraftMain.MODID, name = BallisticraftMain.MODID, version = BallisticraftMain.VERSION)
public class BallisticraftMain
{
    public static final String MODID = "Ballisticraft"; 
    public static final String VERSION = "0.1.0";
     
    @Instance(value = MODID)
    public static BallisticraftMain instance;
